...
namespace Consola
{
    public delegate int DelegadoComparacion(string texto1, string texto2);
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            DelegadoComparacion delegadoComparacion = (texto1, texto2) =>
            {
        ...
        public static void Comparar(string texto1, string texto2, DelegadoComparacion comparacion)
        {
            ...
            Console.WriteLine(comparacion(texto1, texto2));
